...
The ERP ingestion service (ErpCsvParser.java) requires exactly three columns:
...
Usage:
  ...
  python tools/generate_erp_soh.py --sample          # create a sample CSV without reading xlsx
